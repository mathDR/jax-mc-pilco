...
but it is possible to define custom metrics
"""
...
class Distance(eqx.Module):
    ...
    @abstractmethod
    def distance(self, X1: jax.Array, X2: jax.Array) -> jax.Array:
        """Compute the distance between two coordinates under this metric"""
        raise NotImplementedError()

    def squared_distance(self, X1: jax.Array, X2: jax.Array) -> jax.Array:
